...
//  fill(89, 82, 96);
//  let w = width*0.75;
//  rect(w, height - VIDEO_HEIGHT+150, 220, 220);
//  rect(w, height- VIDEO_HEIGHT+400, 220, 220);
//  image(shirts_imgs[best_shirt], w, height - VIDEO_HEIGHT+150, 200, 200);
//  image(pants_imgs[best_pants], w, height- VIDEO_HEIGHT+400, 200, 200);
//  rectMode(CORNER);
//  imageMode(CORNER);
...
//    imageMode(CORNER);
//    let a = map(right_shoulder_x, 0, 640, 0, VIDEO_WIDTH);
//    let b = map(right_shoulder_y, 0, 480, 0, VIDEO_HEIGHT);
//    let c = map(right_shoulder_x+(left_shoulder_x-right_shoulder_x), 0, 640, 0, VIDEO_WIDTH);
//    let d = map( right_shoulder_y + (right_hip_y-right_shoulder_y), 0, 480, 0, VIDEO_HEIGHT);
//    image(shirts_imgs[best_shirt], a, b, c, d);

//    //image(shirts_imgs[best_shirt], right_shoulder_x, right_shoulder_y, right_shoulder_x+(left_shoulder_x-right_shoulder_x), right_shoulder_y + (right_hip_y-right_shoulder_y));
//  }
//}
...
//  //console.log("bad_num: ", imgs_num_lst[0]);
//  //console.log("half_num: ", imgs_num_lst[1]);
//  //console.log("good_num: ", imgs_num_lst[2]);
//  //text(label_s, 0, 500, 300, 200);
//  //text(label_p, 0, 550, 300, 200);
...
//      image(dragons_imgs_lst[img], count_img*step, 0, dragon_size, dragon_size);
...
//  text("Check out those ones", width/2, 0, width/2, height - VIDEO_HEIGHT);
//}
